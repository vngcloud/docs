...
* Để đảm bảo các **VM** trong **NodeGroup** có thể **outbound ra internet** và kết nối tới **Control Plane**, bạn **bắt buộc** phải thiết lập **NAT Gateway**. Bạn có thể chọn sử dụng Palo Alto hoặc Pfsense để làm việc với Private Node Group theo hướng dẫn tại:
...
## 4. Kết nối và kiểm tra thông tin Cluster
...
## 5. Triển khai Workload (Nginx)

#### Bước 1: Tạo Deployment cho Nginx

Tạo file **nginx-service-lb4.yaml** với nội dung:
