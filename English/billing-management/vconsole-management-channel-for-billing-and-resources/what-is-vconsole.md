...
**What is vConsole?**\
vConsole - GreenNode Service is a website that provides comprehensive information about all services offered by GreenNode Service. It helps customers gain a full and clear overview of GreenNode’s ecosystem. Products and services currently available on the vConsole website include vServer, vStorage, vMonitor, vCDN, vColocation, and more.

Through the vConsole website, GreenNode Service users can easily manage financial information related to their service usage, such as billing, payment history, credit usage history, resources statistics, and cost explorer.
...
* **Homepage Dashboard**: Displays basic information about the products provided by GreenNode Service, including vServer, vStorage, vMonitor, vCDN, and more, along with associated services for each product.
...
* **Billing History**: Users can view billing summaries and payment statuses for services across all GreenNode products, such as vServer, vMonitor, vStorage, vCDN, etc.
