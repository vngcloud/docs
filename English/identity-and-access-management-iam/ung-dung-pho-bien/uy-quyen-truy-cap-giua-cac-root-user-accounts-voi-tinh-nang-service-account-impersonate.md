...
To create a Service Account, go to the Service Account tab on the IAM page here [,](https://iam.console.greennode.ai/service-accounts) click **Create a Service Account** , **name** the Service Account: AllowAccessFromRootUserAccountA and click **Add a root user account** to set up Trust with Root User Account A
...
To create a Policy, go to the Policy tab on the IAM page here [,](https://iam.console.greennode.ai/policies) click **Create a Policy** , **name** the Policy: **ImpersonateToRootUserAccountB** and click **Next step**
