...
To create a Policy, go to the Policy tab on the IAM page here [,](https://iam.console.greennode.ai/policies) click **Create a Policy** , **name** the Policy: **vServerFullAccessExceptDeleteServer** and click **Next step**
