...
1. Go to IAM Console: https://iam.console.greennode.ai/&#x20;
...
1. Go to IAM Console - Groups page with URL: https://iam.console.greennode.ai/user-groups&#x20;
...
1. Go to IAM Console - Groups page with the URL: https://iam.console.greennode.ai/user-groups&#x20;
2. Log in as a Root User Account or a User Account with access rights.&#x20;
3. You need to provide a username/email and password when logging in.&#x20;
