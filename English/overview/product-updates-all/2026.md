...
* Learn more at [PostgreSQL Cluster](../../vdb/relational-database-service-rds/postgresql/postgresql-cluster/).
...
* Learn more at [AI Stack — Release Notes](../../ai-stack/release-notes.md).
...
* Learn more at [Auto Healing](../../vks/clusters/configure-auto-healing.md).
...
* Learn more at [Kubeconfig](../../vks/clusters/kubeconfig.md).
...
VKS now lets you collect the Control Plane logs of a Cluster — including **Audit**, **API Server**, **Controller Manager**, **Scheduler** — and send them to your **OpenSearch** or **Kafka** on vDB, for audit, compliance, and troubleshooting.
...
* Learn more at [Configure Cluster Logging](../../vks/monitoring/configure-cluster-logging.md).
...
* Learn more at [Install and use the vMonitor Datasource plugin for Grafana](../../vmonitor/install-vmonitor-grafana-plugin.md).
...
* **Remote (hosted):** use the hosted endpoint right away and sign in with your **GreenNode IAM user** in the browser (OAuth 2.1) — nothing to install, no secret in any config file. See [Configure Remote MCP](../../vks/vks-mcp-server/configure-remote-mcp.md).
* **Local (stdio):** run the server on your own machine, sharing the `~/.greennode` credentials with the GreenNode CLI. See [Configure Local MCP](../../vks/vks-mcp-server/configure-local-mcp.md).
...
* Learn more at [Configure IP Whitelist](../../identity-and-access-management-iam/configure-ip-whitelist.md).
...
* Learn more at [Manage VKS with the GreenNode CLI](../../vks/getting-started/manage-vks-with-the-greennode-cli.md).
...
* Learn more at [Working with vLB-Log](../../vmonitor-platform/cach-tinh-nang-cua-vmonitor-platform/logs/lam-viec-voi-product-logs/lam-viec-voi-vlb-log.md).
...
* Learn more at [Usage & Limits](../../vks/usage-limits.md).
