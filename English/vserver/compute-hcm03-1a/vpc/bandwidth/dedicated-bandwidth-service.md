...
**Step 4**: Under the **IP List** section, select the icon <img src="../../../../../.gitbook/assets/image (65) (1) (2).png" alt="" data-size="line">next to the IP address you want to remove from the package and choose the icon <img src="../../../../../.gitbook/assets/image (66) (2).png" alt="" data-size="line">.
