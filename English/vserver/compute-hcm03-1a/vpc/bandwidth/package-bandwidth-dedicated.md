...
**Step 4:** Under the **IP List** section, select the icon ![](<../../../../../.gitbook/assets/image (71) (1) (2).png>) next to the **IP address** you want to remove from the package and choose the icon ![](<../../../../../.gitbook/assets/image (72) (2).png>)
