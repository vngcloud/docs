...
<figure><img src="https://docs.vngcloud.vn/download/attachments/59803889/image2023-6-8_16-29-44.png?version=1&#x26;modificationDate=1686559205000&#x26;api=v2" alt=""><figcaption></figcaption></figure>

<figure><img src="https://docs.vngcloud.vn/download/attachments/59803889/image2023-6-8_16-29-29.png?version=1&#x26;modificationDate=1686559206000&#x26;api=v2" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://docs.vngcloud.vn/download/attachments/59803889/image2023-6-8_17-21-49.png?version=1&#x26;modificationDate=1686559206000&#x26;api=v2" alt=""><figcaption></figcaption></figure>
...
<figure><img src="https://docs.vngcloud.vn/download/attachments/59803889/image2023-6-9_9-56-22.png?version=1&#x26;modificationDate=1686559207000&#x26;api=v2" alt=""><figcaption></figcaption></figure>
...
| `data "vngcloud_vlb_lb_packages"` `"lb_packages"` `{project_id = var.project_id}` `resource "vngcloud_vlb_load_balancer"` `"example"{project_id = var.project_idname = "example_vlb"package_id = data.vngcloud_vlb_lb_packages.lb_packages.packages[0].uuidscheme = "Internet"subnet_id = var.subnet_idtype` `= "Layer 7"}` |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
