...
_Note: This information is confidential and only sent to registered email. GreenNode cannot intervene to recover vServer's login information (username / password / key) in all situations_
