...
1. Log in to [VNG Cloud Console](https://console.greennode.ai)
...
Refer to the recommendations table in [Section 5](configure-auto-healing.md#5-recommended-configuration-by-cluster-type). Pick the row that matches your cluster's scale and workload characteristics, then fine-tune based on real-world experience.
