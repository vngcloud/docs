...
The progress bar on the right shows the percentage consumed. The line below shows remaining capacity (e.g., *3 clusters remaining*).
...
| I want to... | Go to |
|---|---|
| Create my first cluster | [Getting Started with VKS](getting-started/README.md) |
