...
**Partners are responsible for updating the deal stage information so GreenNode can monitor the deal and ensure the partner's benefits in executing the deal.**
...
* Partners can update deal information by selecting the options to:
  ...
  * For a "**Won Deal**" stage, a discount with the registered rate in the deal will automatically be generated for the partner and applied according to the partner agreement with GreenNode. Additionally, the customer registered by the partner in the deal will become the partner’s customer.
