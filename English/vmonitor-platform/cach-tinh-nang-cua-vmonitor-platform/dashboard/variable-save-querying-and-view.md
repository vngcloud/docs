...
1. In the query command area, select the dropdown icon <img src="../../../../.gitbook/assets/image (142) (1).png" alt="" data-size="original"> (this icon is located next to the Save query icon).
