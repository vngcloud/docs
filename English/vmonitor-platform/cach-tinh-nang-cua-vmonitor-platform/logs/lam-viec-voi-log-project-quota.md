...
We publicize the cost calculation for each log project package on GreenNode's homepage, see [How to calculate fees](https://docs.greennode.ai/vmonitor/cach-tinh-phi) .
...
How to calculate the renewal cost for each Log project package is publicized on the homepage of GreenNode, see [How to calculate fees](https://docs.greennode.ai/vn/vmonitor/cach-tinh-phi) .
...
How to calculate the cost of increasing the limit for each Log project package is publicized on the homepage of GreenNode, see [How to calculate fees](https://docs.greennode.ai/vn/vmonitor/cach-tinh-phi) .
