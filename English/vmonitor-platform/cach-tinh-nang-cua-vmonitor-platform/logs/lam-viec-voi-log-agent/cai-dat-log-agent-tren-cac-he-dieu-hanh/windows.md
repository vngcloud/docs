...
</code></pre></td></tr></tbody></table><p>We recommend that you try running it manually first to identify the problem if there is any.</p></td></tr><tr><td><p>Copy</p><pre><code>cd C:\filebeat-8.7.1-windows-x86_64
.\filebeat.exe -c .\filebeat.yml
