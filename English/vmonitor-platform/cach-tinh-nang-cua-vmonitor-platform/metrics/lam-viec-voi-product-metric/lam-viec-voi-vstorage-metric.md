...
When you create vStorage Projects, the system will automatically collect vStorage metrics and display them in the Infrastructure List/vStorage tab, allowing you to track vStorage Projects on GreenNode completely free of charge.
