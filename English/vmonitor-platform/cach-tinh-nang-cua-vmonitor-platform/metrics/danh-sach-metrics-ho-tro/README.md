...
When Resources on GreenNode are created, by default there will be 2 types of monitors: Basic and Detail
...
To know what each type of monitoring can do, please refer to [the List of Supported Metrics](https://docs.greennode.ai/vmonitor/dashboards/metrics/danh-sach-metrics-ho-tro/danh-sach-metrics-cua-host?fallback=true) .
