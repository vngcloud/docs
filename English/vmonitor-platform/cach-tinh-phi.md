...
* Initially, when you successfully register for a GreenNode account, by default we classify you as a prepaid user. That means you need to pay for the package before you can use the service and the package will have a term depending on the cycle you choose.
...
You can choose the appropriate form to optimize your or your unit's storage costs. For more details, refer to: [Managing invoices, costs & resources on GreenNode](https://docs-vngcloud-vn.translate.goog/vng-cloud-document/v/vn/quan-ly-hoa-don-chi-phi-and-tai-nguyen-tren-vng-cloud) .
