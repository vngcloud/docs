...
1. Login into [https://vmonitor.console.greennode.ai/](https://vmonitor.console.greennode.ai/). If you don't have an account yet, sign up for free at [here](https://register.greennode.ai/signup?hl=en).
...
1. Login into [https://vmonitor.console.greennode.ai/](https://vmonitor.console.greennode.ai/). Choose **Infrastructure List/ Host.**
...
1. Login into [https://vmonitor.console.greennode.ai/](https://vmonitor.console.greennode.ai/). Choose **Dashboard.**
