...
1. Login into [https://vmonitor.console.greennode.ai/](https://vmonitor.console.greennode.ai/). If you don't have an account yet, sign up for free at here.
...
1. Login into [https://vmonitor.console.greennode.ai/](https://vmonitor.console.greennode.ai/). Select **Integration.**
...
1. Login into [https://vmonitor.console.greennode.ai/](https://vmonitor.console.greennode.ai/). Select **Log.**
2. Select **Log search**.
