...
Object Storage (HAN02) provides a range of APIs for managing data and interacting with your cloud storage resources. Here is a summary of the main types of APIs we provide:
...
*   **Create Bucket** : Create a new bucket.
    ...
    * For example: `PUT https://han02.vstorage.vngcloud.vn/demobucket`
    * Or Curl via command:
...
*   **List Buckets** : List all buckets belonging to the user.
    ...
    * Path: `GET /`
    * For example: `GET https://han02.vstorage.vngcloud.vn/`
    * Or Curl via command:
...
* **Delete Bucket** : Delete a bucket (only if the bucket is empty).
  ...
  * For example: `DELETE https://han02.vstorage.vngcloud.vn/demobucket`
  *   Or Curl via command:
...
* **GET Bucket (List Objects)** : List objects in a bucket.
  ...
  * For example: `GET https://han02.vstorage.vngcloud.vn/demobucket`
  *   Or Curl via command:
...
* **HEAD Bucket** : Check for existence and access to bucket.
  ...
  * For example: `HEAD https://han02.vstorage.vngcloud.vn/demobucket`
  *   Or Curl via command:
...
* **GET Bucket ACL** : Get the bucket's access control list (ACL).
  ...
  * For example: `GET https://han02.vstorage.vngcloud.vn/demobucket?acl`
  *   Or Curl via command:
...
* **PUT Bucket ACL** : Set ACL for bucket.
  ...
  * For example: `PUT https://han02.vstorage.vngcloud.vn/demobucket?acl`
  *   Or Curl via command:
...
* **GET Object ACL** : Get the ACL of an object.
  ...
  * For example: `GET https://han02.vstorage.vngcloud.vn/demobucket/videoplayback.mp4?acl`
  *   Or Curl via command:
...
* **PUT Bucket Make Public:** Set up a Public Bucket
  ...
  * For example: `PUT https://han02.vstorage.vngcloud.vn/demobucket01/?publicAccessBlock`
  *   Or Curl via command:
...
* **GET Bucket Make Public:** Get public or private bucket information.
  * Path: `GET /<bucket-name>/?publicAccessBlock`
  * For example: `GET https://han02.vstorage.vngcloud.vn/demobucket01/?publicAccessBlock`
  *   Or Curl via command:
...
* **PUT Bucket Versioning** : Enable or disable versioning for the bucket.
  ...
  * For example: `PUThttps://han02.vstorage.vngcloud.vn/demobucket?versioning`
  *   Or Curl via command:
...
* **GET Bucket Versioning** : Check the bucket versioning status.
  ...
  * For example: `GET https://han02.vstorage.vngcloud.vn/demobucket?versioning`
  *   Or Curl via command:
...
* **GET Object Versions** : List versions of objects in the bucket.
  ...
  * For example: `GET https://han02.vstorage.vngcloud.vn/demobucket/?versions`
  *   Or Curl via command:
...
* **PUT Bucket Lifecycle** : Initializes lifecycle expiration for a bucket.
  ...
  * For example: `PUT https://han02.vstorage.vngcloud.vn/demobucket?lifecycle`
  *   Or Curl via command:
...
* **GET Bucket Lifecycle** : Get bucket lifecycle rule information.
  ...
  * For example: `GET https://han02.vstorage.vngcloud.vn/demobucket?lifecycle`
  *   Or Curl via command:
...
* **DELETE Bucket Lifecycle** : Deletes the lifecycle rules set for the bucket.
  ...
  * For example: `DELETE https://han02.vstorage.vngcloud.vn/demobucket?lifecycle`
  *   Or Curl via command:
...
* **PUT Bucket Website** : Set up the bucket as a static website.
  ...
  * For example: `PUT https://han02.vstorage.vngcloud.vn/demobucket?cors`
  *   Or Curl via command:
...
* **GET Bucket Website** : Get the bucket's website configuration.
  ...
  * For example: `GET https://han02.vstorage.vngcloud.vn/demobucket?cors`
  *   Or Curl via command:
...
* **DELETE Bucket Website** : Deletes the bucket's website configuration.
  ...
  * For example: `DELETE https://han02.vstorage.vngcloud.vn/demobucket?cors`
  *   Or Curl via command:
...
* **Update Object Locked Configuration:** Used to upload objects into a bucket.
  ...
  * For example: `PUT https://han02.vstorage.vngcloud.vn/demoobjectlocked?object-lock`
  *   Or Curl via command:
...
* **PUT Object** : Used to upload objects into a bucket.
  ...
  * For example: `PUT https://han02.vstorage.vngcloud.vn/demobucket/demoobject.txt`
  *   Or Curl via command:
...
* **GET Object** : Get an object from S3.
  ...
  * For example: `GET https://han02.vstorage.vngcloud.vn/demobucket/demoobject.txt`
  *   Or Curl via command:
...
* **DELETE Object** : Delete an object from S3.
  ...
  * For example: `DELETE https://han02.vstorage.vngcloud.vn/demobucket/demoobject.txt`
  *   Or Curl via command:
...
* **HEAD Object** : Query object metadata without downloading content.
  ...
  * For example: `HEAD https://han02.vstorage.vngcloud.vn/demobucket/demoobject.txt`
  *   Or Curl via command:
...
* **COPY Object** : Copy an object from one S3 location to another.
  ...
  * For example: `PUT https://han02.vstorage.vngcloud.vn/demobucket01/demoobject.txt`
  * Or Curl via command:
