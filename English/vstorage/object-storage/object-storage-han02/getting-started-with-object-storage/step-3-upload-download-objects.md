...
1. Login to [https://vstorage.console.greennode.ai](https://vstorage.console.greennode.ai/storage/list). Select **project** and **bucket** you want to upload objects to.
2. Select **Upload**.
...
1. Login to [https://vstorage.console.greennode.ai](https://vstorage.console.greennode.ai/storage/list). Select **project** and **bucket** you want to download the object from.
