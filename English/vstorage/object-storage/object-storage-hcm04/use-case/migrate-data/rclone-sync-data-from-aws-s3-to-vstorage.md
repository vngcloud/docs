...
**DataSync** is a service developed by GreenNode that aims to transfer data securely, automatically and quickly between object storage services. With DataSync, you can:

* Transfer data from International Clouds to GreenNode, specifically:
