...
* **Root User Account:** This is the initial account created to access GreenNode with full access rights to all resource services on GreenNode.
...
* **Service Account:** This account is used by an application/machine to execute API calls that are authorized and access specified resources on GreenNode.
