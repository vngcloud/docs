...
1\. Log in to [https://vstorage.console.greennode.ai](https://vstorage.console.greennode.ai/). Choose the **project** and **container** that contains the object you want to copy.\
