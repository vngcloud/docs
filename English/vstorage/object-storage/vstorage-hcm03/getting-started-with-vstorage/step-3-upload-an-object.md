...
1. Log in to [https://vstorage.console.greennode.ai](https://vstorage.console.greennode.ai/). Choose the **project** and **container** to which you want to upload the object.
2. Select **Upload**.
