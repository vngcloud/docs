...
A Project is a term in vStorage that represents a storage package with a specific capacity that you purchase on GreenNode. At any given time, you can own one or more Projects simultaneously and use them to organize resources for different groups or departments with different purposes.
