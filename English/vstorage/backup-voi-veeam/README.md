...
**GreenNode**'s storage system is also a service widely used by businesses for data backup, especially when integrating data backup with Veeam. Thus, the GreenNode system provides feature support to help customers backup data in the most secure and safe manner.

***

## GreenNode supports backup features

As mentioned, the GreenNode system offers customers features that support data backup:
