...
File Storage products set resource limits to ensure that we can provide fast and flexible service to all customers. These resource limits are the maximum we recommend and some resource limits can be customized according to your storage needs. To submit a request for a limit increase, please visit the GreenNode Support Center and create a request [here](https://helpdesk.greennode.ai/portal/en/newticket) .
