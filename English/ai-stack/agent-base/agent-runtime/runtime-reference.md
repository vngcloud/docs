...
1. Open the runtime detail page â†’ **"Edit"**
2. Modify image URL, flavor, autoscaling, or env vars â†’ **Save**

#### Delete a Runtime

> **Warning:** Deletion is irreversible. This permanently removes the runtime and all its endpoints.

In Runtime detail page, find the runtime â†’ **Delete** â†’ confirm
...
**Possible statuses:** `CREATING` â†’ `ACTIVE` (success) or `ERROR` (failed)
...
1. Open the runtime detail page â†’ **"Endpoints"** tab

#### Create Endpoint

1. On the runtime detail page â†’ **"Endpoints"** tab â†’ **"Create Endpoint"**
2. Fill in **Name** and **Version** â†’ **Create**

#### Update Endpoint Version

1. On the **"Endpoints"** tab â†’ click an endpoint â†’ **"Edit"**
2. Change **Version** â†’ **Save**
