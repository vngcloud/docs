...
> Currency is fixed at **VND** — no other currency option is available. **Enable Budget Unlimited** toggle: when turned ON, the system removes the monthly cap and allows unlimited spending. Leave it OFF to keep the limit active.
