...
</code></pre></td></tr></tbody></table><ul><li>Nếu cài thủ công, chạy lệnh</li></ul><table data-header-hidden><thead><tr><th></th></tr></thead><tbody><tr><td><pre><code>Tải tệp tin rpm: curl -L -O https://artifacts.elastic.co/downloads/beats/filebeat/filebeat-8.7.1-x86_64.rpm
...
</code></pre></td></tr></tbody></table><ul><li>Nếu cài thủ công, chạy lệnh</li></ul><table data-header-hidden><thead><tr><th></th></tr></thead><tbody><tr><td><pre><code>Cài java (>8): sudo yum install jre-1.8.0-openjdk -y
