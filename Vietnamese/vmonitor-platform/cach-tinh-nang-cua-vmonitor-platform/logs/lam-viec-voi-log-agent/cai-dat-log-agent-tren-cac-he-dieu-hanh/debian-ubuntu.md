...
<table data-header-hidden><thead><tr><th></th></tr></thead><tbody><tr><td><pre><code>Cài java (>8): sudo apt-get install openjdk-8-jre-headless -y
...
journalctl -f --unit logstash
tail -f /var/log/logstash
</code></pre></td></tr><tr><td><pre><code>apt remove --purge logstash
</code></pre></td></tr></tbody></table>
{% endtab %}
{% endtabs %}
