...
* Tên Dashboard phải là duy nhất trong một tài khoản GreenNode cho đến khi Dashboard đó bị xóa.
...
1. Đăng nhập vào vMonitor Platform [tại đây.](https://vmonitor.console.greennode.ai/)
2. Chọn thư mục **Dashboard.**
3. Tại **Dashboard** mà bạn muốn thay đổi tên, chọn biểu tượng<img src="../../../../.gitbook/assets/image (23) (3).png" alt="" data-size="line">
4. Chọn **Rename**.
...
1. Đăng nhập vào vMonitor Platform [tại đây.](https://vmonitor.console.greennode.ai/)
2. Chọn thư mục **Dashboard.**
3. Tại **Dashboard** mà bạn muốn tạo bản sao, chọn <img src="../../../../.gitbook/assets/image (23) (3).png" alt="" data-size="line">
...
1. Đăng nhập vào vMonitor Platform [tại đây.](https://vmonitor.console.greennode.ai/)
2. Chọn thư mục **Dashboard.**
3. Tại **Dashboard** mà bạn muốn xóa, chọn <img src="../../../../.gitbook/assets/image (23) (3).png" alt="" data-size="line">
4. Chọn **Delete**.
