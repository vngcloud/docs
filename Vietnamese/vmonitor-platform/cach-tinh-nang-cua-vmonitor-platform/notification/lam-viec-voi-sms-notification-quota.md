...
Một SMS Notification quota là một thuật ngữ trên vMonitor Platform thể hiện một gói thông báo thông qua tin nhắn văn bản với số lượng tin nhắn cụ thể mà bạn thực hiện mua sắm trên GreenNode. Tại một thời điểm bạn chỉ có thể sở hữu một SMS Notification quota và sử dụng chúng để gửi thông báo theo mong muốn của bạn.
...
1. Đăng nhập vào [https://vmonitor.console.greennode.ai/](https://vmonitor.console.greennode.ai/). Nếu bạn chưa có tài khoản, đăng ký miễn phí tại [tại đây](https://register.vngcloud.vn/signup).
2. Chọn thư mục **Quota\&Usage.**
3. Chọn **Paid notification usage**.
...
Bạn chỉ có thể gia hạn sử dụng gói SMS notification quota trong vòng 7 ngày trước thời điểm hết hạn của gói notification hiện tại. Cách tính chi phí gia hạn cho mỗi gói SMS notification quota được chúng tôi công khai trên trang chủ của GreenNode, hãy xem tại [Cách tính phí](../../cach-tinh-phi.md).
...
Cách tính chi phí tăng hạn mức cho mỗi gói SMS notification quota được chúng tôi công khai trên trang chủ của GreenNode, hãy xem tại [Cách tính phí](../../cach-tinh-phi.md).
