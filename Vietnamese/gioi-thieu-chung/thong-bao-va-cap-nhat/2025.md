...
* **Public VIP** (Hỗ trợ khi khởi tạo VM hay trên Marketplace) . Tính năng này giúp tăng tính High Availability, giúp xây dựng giải pháp active-standby cho các VM cần public service, và IP sẽ ko bị đổi trong quá trình failover active/standby. Ngoài ra, tính năng này giúp hỗ trợ quá trình Migration, giúp dễ dàng chuyển đổi IP sang VM, hay Marketplace mới. Khách hàng có thể tự chủ giữ VM khi migration sang VM mới.&#x20;

Tính năng này đã hỗ trợ ở tất cả Region và Zone của vServer. Tìm hiểu thêm cách khởi tạo [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/vserver/compute-hcm03-1a/network/virtual-ip).

* **Multi External Interface:** Tính năng attach multi external interface vào Server nhằm mục đích phân tách services/traffic, failover interface, tiết kiệm chi phí hơn khi không cần phải mua nhiều Server. Tính năng này giúp mỗi ứng dụng trong VM tương ứng 1 IP, giúp dễ dàng quản lý traffic. Ngoài ra còn giúp tăng tính High Availability, khi VM gặp sự cố, người dùng dễ dàng tháo Interface ra và gắn vào VM backup.

Tìm hiểu thêm cách khởi tạo [tại đây](https://docs.vngcloud.vn/vng-cloud-document/vn/attach-multi-external-interface-vao-server).

**vBackup: Cải thiện tính năng cho phép bổ sung thông tin người nhận thông báo trên Portal**

Ngoài tài khoản Root account, việc cấu hình thêm email nhận thông báo sẽ giúp người dùng chủ động hơn trong việc quản lý tài khoản và dịch vụ theo đội/nhóm, đảm bảo hoạt động của hệ thống luôn ổn định và hiệu quả. Hệ thống hỗ trợ cài đặt với các loại thông báo liên quan đến hết hạn tài nguyên, tự động gia hạn và thanh toán hóa đơn.
