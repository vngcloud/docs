...
2. Chọn Backup Server cần xem backup server point. Bạn có thể nhấn vào ô tìm kiếm, nhập tên backup server cần tìm. ![](<../../../../.gitbook/assets/image (767) (1).png>)
...
<figure><img src="../../../../.gitbook/assets/image (769) (1).png" alt=""><figcaption></figcaption></figure>
