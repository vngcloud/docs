...
2. **Truy cập vào phần quản lý Backup Location:** Tìm và chọn mục "Backup Location" tại đây [https://backupcenter.console.greennode.ai/backup-location/list](https://backupcenter.console.greennode.ai/backup-location/list)
...
*   **Bật Soft Delete:** Tìm và bật tùy chọn "Edit Soft Delete".
    ...
    <figure><img src="../../../../.gitbook/assets/image (752) (2).png" alt=""><figcaption></figcaption></figure>
...
*   **Bật Location Lock:** Nhấp vào nút "Configure Location lock", một cửa số giao diện sẽ hiện lên cho phép bạn điền các thông tin cần thiết.
    ...
    <figure><img src="../../../../.gitbook/assets/image (752) (1) (1).png" alt=""><figcaption></figcaption></figure>
