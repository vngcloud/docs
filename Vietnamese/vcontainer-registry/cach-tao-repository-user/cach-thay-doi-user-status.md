...
1. Tại trang chủ Container Registry, nhấn vào **menu "Repository User"** phía bên tay trái để truy cập đến danh sách Repository User, tại cột "Action", nhấn vào biểu tượng "ba chấm" tại Repository User cần chỉnh sửa, chọn **"Disable/Enable"** để thực hiện thay đổi.
