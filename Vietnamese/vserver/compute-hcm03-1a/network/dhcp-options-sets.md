...
1. Đăng nhập vào VNG Cloud, tìm đến dịch vụ vServer;
2. Tại màn hình vServer, chọn vùng (region) phù hợp;
3. Trên thanh điều hướng bên tay trái, chọn **DHCP options sets**;
...
{% hint style="danger" %}
**Cần lưu ý khi xóa DHCP options set:**

* Xóa (Detach) việc gán VPC của DHCP cũng trong màn hình chi tiết DHCP;
* Chỉ xóa được DHCP khi không có VPC nào được gán vào.
{% endhint %}
