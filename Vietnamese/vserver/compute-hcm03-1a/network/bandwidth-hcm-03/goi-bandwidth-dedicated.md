...
**Bước 1**: Đăng nhập vào tài khoản GreenNode của bạn và truy cập vào [https://hcm-3.console.greennode.ai/vserver/](https://hcm-3.console.greennode.ai/vserver/)
...
**Bước 4**: Chọn biểu tượng **Action** tại **Dedicated** **bandwidth** bạn muốn thay đổi gói và chọn **Resize**
