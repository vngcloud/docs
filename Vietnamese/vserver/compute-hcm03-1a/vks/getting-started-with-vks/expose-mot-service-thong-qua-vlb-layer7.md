...
**Bước 5: Để truy cập vào app nginx, bạn có thể sử dụng Endpoint của Load Balancer mà hệ thống đã tạo.**&#x20;

```
http://Endpoint/
```

Bạn có thể lấy thông tin Public Endpoint của Load Balancer tại giao diện vLB. Cụ thể truy cập tại [https://hcm-3.console.vngcloud.vn/vserver/load-balancer/vlb/detail/lb-6cdea8fd-4589-410e-933f-c3bc46fa9d25](https://hcm-3.console.vngcloud.vn/vserver/load-balancer/vlb/detail/lb-6cdea8fd-4589-410e-933f-c3bc46fa9d25)

Ví dụ, bên dưới tôi đã truy cập thành công vào app nginx với địa chỉ : [http://180.93.181.108/](http://180.93.181.108/)
