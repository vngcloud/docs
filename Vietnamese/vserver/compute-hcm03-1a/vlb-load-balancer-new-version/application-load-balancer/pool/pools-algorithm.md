...
Thuật toán Cân bằng tải sẽ xác định Member (server) nào được chọn khi cân bằng tải. Load Balancer của GreenNode cung cấp ba loại thuật toán Cân bằng tải như sau:
