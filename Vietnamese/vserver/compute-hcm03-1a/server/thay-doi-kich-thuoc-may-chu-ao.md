...
1. Đăng nhập vào GreenNode portal và đi đến trang dịch vụ vServer tại đường link: [https://hcm-3.console.greennode.ai/vserver/v-server/cloud-server](https://hcm-3.console.greennode.ai/vserver/v-server/cloud-server)
