...
* Chiết khấu mua dịch vụ là mức chiết khấu GreenNode dành cho đối tác nhằm mở rộng kênh phân phối dịch vụ GreenNode
* Đối tác có thể vào chức năng này trên partner portal để đăng ký mức chiết khấu mong muốn, khi GreenNode duyệt mức chiết khấu đã đăng ký đại lý sẽ được hưởng mức chiết khấu này khi có đơn hàng của khách hàng được tạo tại thời điểm discount ở trạng thái "Đang có hiệu lực".
...
Sau khi nhấn “**Đăng Ký**”, chiết khấu vừa tạo chuyển sang trạng thái “Chờ Duyệt”, đồng thời người dùng nhận được email thông báo việc đăng ký chiết khấu đang được GreenNode xem xét.

Trong vòng 3 ngày làm việc, chiết khấu vừa đăng ký sẽ được GreenNode duyệt hoặc từ chối. Trạng thái của chiết khấu sẽ được cập nhật ngay trên màn hình này khi có xác nhận của GreenNode

* Nếu GreenNode duyệt chiết khấu đã đăng ký, trạng thái sẽ được chuyển thành “Chờ kích hoạt”.
...
* _Nếu ngày GreenNode duyệt chiết khấu > ngày hiệu lực chiết khấu do người dùng nhập, ngày hiệu lực chiết khấu sẽ được cập nhật bằng ngày duyệt chiết khấu_
