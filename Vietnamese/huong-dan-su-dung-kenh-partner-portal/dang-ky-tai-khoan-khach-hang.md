...
Đối tác/ Đại lý có thể thực hiện đăng ký khách hàng ngay trên portal GreenNode nhằm mục đích

* Chính thức xác nhận khách hàng của đại lý (sau khi được GreenNode xác nhận)
...
* Sau bước xác nhận của khách hàng, yêu cầu này sẽ được chuyển đến GreenNode để xác nhận đồng ý trong trường hợp khách hàng này đang không phải là khách hàng của GreenNode.
* Khi khách hàng của đại lý được GreenNode duyệt , trạng thái này sẽ được cập nhật thành “Đã xác nhận”
