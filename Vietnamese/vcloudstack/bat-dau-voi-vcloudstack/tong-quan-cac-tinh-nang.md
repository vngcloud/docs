...
vCloudStack là dịch vụ đám mây hybrid được thiết kế quản lý và cho phép mở rộng cơ sở hạ tầng, dịch vụ, API của GreenNode đến cơ sở của khách hàng. Bằng cách cung cấp quyền truy cập cục bộ vào cơ sở hạ tầng do GreenNode quản lý. vCloudStack cho phép khách hàng xây dựng và vận hành các ứng dụng tại chỗ sử dụng cùng các giao diện lập trình như trong GreenNode, đồng thời sử dụng tài nguyên và lưu trữ cục bộ để làm giảm độ trễ và đáp ứng nhu cầu xử lý dữ liệu cục bộ.

Do đó, vCloudStack mang tính chất và tính năng cơ bản gần như giống với các tính năng dịch vụ mà vServer của GreenNode đang cung cấp.

***

## Các tính năng <a href="#cac-tinh-nang" id="cac-tinh-nang"></a>

Từ mô hình đám mây hybrid này, vCloudStack của GreenNode cung cấp các tính năng như sau mà bạn có thể sử dụng gồm:
