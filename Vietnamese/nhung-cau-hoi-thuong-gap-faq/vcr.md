...
Muốn xóa image cũ Quý khách cần truy cập vào vCR Console. Xem hướng dẫn truy cập tại đây [https://docs.greennode.ai/vn/vcontainer-registry/bat-dau-voi-vcr](https://docs.greennode.ai/vn/vcontainer-registry/bat-dau-voi-vcr).
