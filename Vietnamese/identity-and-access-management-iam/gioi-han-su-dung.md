...
Trong hệ thống IAM (Quản lý danh tính và Truy cập) của GreenNode, có một số hạn chế về số lượng  đối tượng IAM có thể sử dụng trong hệ thống. Những hạn chế này được thiết lập để đảm bảo việc phân bổ tài nguyên hiệu quả và ngăn ngừa việc lạm dụng hoặc tiêu thụ tài nguyên quá mức. Những hạn chế này sẽ thay đổi tùy thuộc vào đối tượng đang được sử dụng. Dưới đây là một số điểm chính để giới thiệu về những hạn chế này:

* Truy cập IAM Console để xem Quota & Limitation tại đây: [https://iam.console.greennode.ai/quotas](https://iam.console.greennode.ai/quotas)
...
Mặc định, IAM GreenNode Service sẽ đặt ra giới hạn cho các thuộc tính như bên dưới:
