...
1. Truy cập vào IAM Console - Trang User account với URL: [https://iam.console.greennode.ai/user-accounts](https://iam.console.greennode.ai/user-accounts)
...
1. Navigate to the IAM Console: [https://iam.console.greennode.ai/](https://iam.console.greennode.ai/)
...
1. Access the IAM Console - User Account page with the URL: [https://iam.console.greennode.ai/user-accounts](https://iam.console.greennode.ai/user-accounts)
