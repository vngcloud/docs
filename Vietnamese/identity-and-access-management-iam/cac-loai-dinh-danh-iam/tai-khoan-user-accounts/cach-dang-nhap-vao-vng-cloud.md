# Cách đăng nhập vào GreenNode

Tại GreenNode Service, người dùng có thể truy cập đến các website portal thuộc hệ sinh thái GreenNode Services với tư cách là Root User Accounts hoặc IAM User Accounts
...
* Truy cập vào 1 trong các website portal thuộc hệ thống GreenNode Service hoăc truy cập vào đường dẫn đăng nhập của GreenNode Console trong trường hợp bạn không nhớ chính xác URL Portal mà mình muốn truy cập: [https://hcm-3.console.greennode.ai](https://hcm-3.console.greennode.ai/).
...
Lưu ý rằng việc đăng nhập bằng **Root User Account** sẽ cung cấp quyền truy cập toàn bộ hệ thống GreenNode, trong khi đăng nhập bằng **IAM User Account** sẽ cung cấp quyền truy cập dựa trên các chính sách và phân quyền được cấu hình cho tài khoản đó.
