...
**Bước 1:** Truy cập thành công vào GreenNode, tại màn hình Console chọn đến dịch vụ vNetwork hoặc nhấn vào đầy để đến vNetwork Dashboard HCM03 [https://hcm-3-vnetwork.console.vngcloud.vn/overview](https://hcm-3-vnetwork.console.vngcloud.vn/overview). Sau đó truy cập VPN/Site-to-Site VPN để xem danh sách VPN
