...
**Bước 1:** Truy cập thành công vào GreenNode, tại màn hình Console chọn đến dịch vụ vNetwork hoặc nhấn vào đầy để đến vNetwork Dashboard HCM03 [https://hcm-3-vnetwork.console.greennode.ai/overview](https://hcm-3-vnetwork.console.greennode.ai/overview). Sau đó truy cập VPN/Site-to-Site VPN để xem danh sách VPN

<figure><img src="../../../.gitbook/assets/image (140) (3).png" alt=""><figcaption><p>VPN List</p></figcaption></figure>
