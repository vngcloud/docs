...
| Xem giới hạn và hạn chế               | [Giới hạn và hạn chế](https://github.com/vngcloud/docs/blob/main/Vietnamese/vdb/memorystore-database-service-mds/redis-cluster/gioi-han-redis-cluster.md) |
