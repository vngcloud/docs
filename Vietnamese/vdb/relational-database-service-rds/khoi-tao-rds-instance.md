...
* **Bước 3 Cài đặt phiên bản DB:** bạn lựa chọn
  ...
  * **Master password**: password của master user. GreenNode khuyến nghị bạn đặt password đủ mạnh và lưu trữ password này tại nơi an toàn. Để đảm bảo an toàn thông tin, password cần thỏa tất cả yêu cầu tối thiểu như sau:
