...
Đối với **PostgreSQL Cluster**, để tăng cường bảo mật, bạn có thể thêm `sslmode=require` vào chuỗi kết nối, ví dụ: `psql "host=<Endpoint_vDB> port=5432 dbname=<Database_Name> user=<master_user> sslmode=require"`.
