...
Database Proxy cung cấp connection pooling và load balancing cho cluster. Tính năng này đang được phát triển và sẽ ra mắt trong **Phase 2**. Vui lòng theo dõi trang [Thông báo và Cập nhật](../announcements/) để nắm thông tin mới nhất.
