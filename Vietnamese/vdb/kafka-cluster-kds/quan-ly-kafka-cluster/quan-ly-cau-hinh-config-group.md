...
* **Truy cập Kafka Config Group:** Đăng nhập vào vDB và chọn trang Config Group tại đây: [https://vdb.console.greennode.ai/kafka/config-group](https://vdb.console.greennode.ai/kafka/config-group)
