...
**1. Chọn Cụm Kafka:** Đăng nhập vào vDB Kafka Cluster tại đây [https://vdb.console.greennode.ai/kafka/cluster](https://vdb.console.greennode.ai/kafka/cluster) và chọn cụm Kafka mà bạn muốn điều chỉnh.
