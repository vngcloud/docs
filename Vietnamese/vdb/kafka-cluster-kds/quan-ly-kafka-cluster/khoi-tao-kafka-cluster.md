...
1. Mở trình duyệt web và truy cập vào giao diện quản lý Kafka của GreenNode tại đây: [https://vdb.console.greennode.ai/kafka/cluster](https://vdb.console.greennode.ai/kafka/cluster)
