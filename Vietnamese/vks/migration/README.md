...
* **Bước 1:** Chuẩn bị cluster đích (Prepard target resource): trên hệ thống VKS, bạn cần thực hiện khởi tạo một Cluster theo hướng dẫn tại [đây](/broken/pages/YA15uLM4EtF7asOfWANZ). Đảm bảo rằng cấu hình của cluster đích giống với cấu hình của cluster nguồn.
...
* [Migrate Cluster from VKS to VKS](/broken/pages/rT1ocrwfxhvuQFrNwSvc)
* [Migrate Cluster from vContainer to VKS](/broken/pages/WCb4EKA6idQgQb8Cho6B)
* [Migrate Cluster from another platform to VKS](/broken/pages/Q4GIGqT9WTkotdJsBXjF)
