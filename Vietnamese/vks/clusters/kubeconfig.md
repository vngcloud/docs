...
Sau khi renew, bạn cần tải xuống lại file kubeconfig mới và thay thế file cũ. Certificate vẫn sẽ hoạt động cho đến khi hét hạn sau khi đã renew.
{% endhint %}

### Tải xuống lại Kubeconfig mới

Thực hiện lại các bước trong mục [Tải xuống Kubeconfig](#tải-xuống-kubeconfig) để lấy file kubeconfig mới với certificate còn hiệu lực.
