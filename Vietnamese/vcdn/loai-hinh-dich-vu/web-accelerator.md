...
<figure><img src="../../../.gitbook/assets/image (20) (1) (1) (1) (1) (1) (2).png" alt=""><figcaption></figcaption></figure>
...
*   **Page Rules:** Tính năng này giúp khách hàng tối ưu các điều kiện và các tùy chọn để giúp website thể hiện được nhiều mục đích khác nhau. Để tạo Page rules, vui lòng chọn **Create Page Rule**, popup sẽ hiện ra, lúc này bạn cần chọn:
    ...
    * Chọn **Save changes** để lưu thay đổi.
    ...
    <figure><img src="/broken/files/8lMrzA74RHRsSBsrOvUI" alt=""><figcaption></figcaption></figure>

    <figure><img src="/broken/files/aWXowreaZFN9UIRHwi4c" alt="" width="375"><figcaption></figcaption></figure>

    <figure><img src="/broken/files/EUzaatgfgIpQ3c8pbPf8" alt="" width="348"><figcaption></figcaption></figure>
