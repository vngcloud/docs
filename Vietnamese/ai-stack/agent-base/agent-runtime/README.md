...
![Agent Runtime — tab Custom Agent](<../../../../.gitbook/assets/agent-runtime-custom-tab-list (1).png>)
...
![Agent Runtime — tab OpenClaw](<../../../../.gitbook/assets/agent-runtime-openclaw-tab-list (1).png>)
...
Kéo image từ Container Registry của tổ chức bạn. Xem [Container Registry](../container-registry/).
...
| Sử dụng agent từ Marketplace          | [Marketplace](../marketplace/)          |
