...
![Runtime detail — Endpoints tab](<../../../../.gitbook/assets/1774594267224 (3).png>)
...
![Runtime detail — Versions tab](<../../../../.gitbook/assets/1774594455831 (3).png>)
...
| Cấu hình MCP Gateway | [MCP Governance](https://github.com/vngcloud/docs/blob/main/Vietnamese/ai-stack/agent-base/mcp-governance/README.md) |
