...
1. Đăng nhập vào [GreenNode AI Platform Portal](https://aiplatform.console.greennode.ai/mcp-gateway).
...
![Danh sách MCP Gateway](<../../../../../.gitbook/assets/MCP-gateway-list (1).png>)
...
![Tạo MCP Gateway](<../../../../../.gitbook/assets/create-mcp-gateway (1).png>)
...
1. Chọn **Inbound Auth type**:
   * **JSON Web Tokens (JWT)** _(mặc định)_ — agent đính kèm JWT khi gọi vào gateway
...
![Cấu hình Private VPC — MCP Gateway](<../../../../../.gitbook/assets/gateway-private-vpc (1).png>)
...
![MCP Gateway Detail — tab MCP Servers](<../../../../../.gitbook/assets/mcp-gateway-detail-tab-mcpserver (1).png>)

![MCP Gateway Detail — tab Inbound Auth](<../../../../../.gitbook/assets/mcp-gateway-detail-tabinbound (1).png>)

![MCP Gateway Detail — tab Policy](<../../../../../.gitbook/assets/mcp-gateway-detail-tabpolicy (1).png>)
...
| ------------------------------------------------- | --------------------- |
| Tìm hiểu Policy Group để kiểm soát quyền truy cập | [MCP Governance](../) |
| Hiểu kiến trúc MCP Gateway                        | [MCP Gateway](./)     |
