...
![Policy Group — Evaluation Flow](<../../../../../.gitbook/assets/policy_group_flow (1).png>)
...
| Hiểu MCP Gateway hoạt động như thế nào | [MCP Gateway](../mcp-gateway/)                  |
| Cấu hình MCP Governance tổng quan      | [MCP Governance](../)                           |
