...
1. Đăng nhập vào [AI Platform Console](https://aiplatform.console.greennode.ai)
2. Chọn **AgentBase** trong menu trái
3. Chọn **MCP Governance** → **Policy Groups**

![Danh sách Policy Groups](<../../../../../.gitbook/assets/Policy-group-list (2).png>)
...
![Policy Group Detail](<../../../../../.gitbook/assets/policy-group-detail (2).png>)

![Chi tiết Policy trong Group](<../../../../../.gitbook/assets/policy-in-policygroup-detail (2).png>)
...
| --------------------------------------- | ------------------------------------------------------------ |
| Hiểu evaluation flow hoạt động chi tiết | [Policy Groups — Tổng quan](./)                              |
