...
![Budget & Alerts](<../../../../.gitbook/assets/Budget-Alerts (1).png>)
...
> Đơn vị cố định là **VND** — không có tùy chọn currency khác. Toggle **Enable Budget Unlimited**: khi bật ON, hệ thống bỏ giới hạn và cho phép chi tiêu không giới hạn. Mặc định để OFF để giữ nguyên hạn mức.
...
| Tổng quan Usage & Budget                       | [Usage & Budget](./)                  |
