...
| Tôi muốn... | Đi đến |
|---|---|
| Xem usage, cost và dự báo chi phí cuối tháng | [Xem Usage & Cost](xem-usage-cost.md) |
| Đặt hạn mức ngân sách và cấu hình cảnh báo | [Cấu hình Budget & Alerts](budget-alert.md) |
