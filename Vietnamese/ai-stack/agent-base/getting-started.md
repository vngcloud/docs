...
![1774518047320](<../../../.gitbook/assets/1774518047320 (3).png>)
...
| Deploy và chạy agent của tôi              | [Runtime](/broken/pages/AGc4BTrJ5wgrATGsoRt7)                                             |
| Thêm Memory hội thoại                     | [Memory](memory/)                                                                         |
| Giám sát và debug                         | [Insight](agent-runtime/logs-va-metrics.md)                                               |
...
> **Lần đầu?** Bắt đầu với [Access Control](access-control/) → [Supporting Services (vCR)](supporting-services.md#container-registry-vcr) → [Runtime](/broken/pages/AGc4BTrJ5wgrATGsoRt7) để đi từ con số không đến một agent đang chạy.
