...
* Ít nhất một API Key đã tạo (xem [Access Control](../access-control/))
...
![Danh sách Rate Limit](<../../../../.gitbook/assets/rate-limit-list (2).png>)
...
![Tạo Rate Limit](<../../../../.gitbook/assets/Create-rate-limit (2).png>)
...
| Quản lý API Key           | [Access Control](../access-control/) |
