...
<figure><img src="../../../../.gitbook/assets/ai_coding_flow (2).png" alt=""><figcaption><p>Hai chuẩn API cùng kết nối tới một MaaS endpoint, dùng chung Model Pool</p></figcaption></figure>
