...
1. Đăng nhập vào [https://vstorage.console.greennode.ai](https://vstorage.console.greennode.ai/storage/list). Chọn **project** và **container** chứa object muốn thực hiện xóa.
