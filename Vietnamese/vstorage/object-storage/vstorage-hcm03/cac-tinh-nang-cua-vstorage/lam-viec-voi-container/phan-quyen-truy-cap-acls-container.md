...
Bạn có thể cấp quyền Đọc, Ghi hoặc Đọc và Ghi cho một hoặc tất cả tài khoản người dùng Root khác (Tài khoản người dùng Root được cấp quyền truy cập qua ACLs phải là tài khoản được hợp lệ trên hệ thống GreenNode của chúng tôi).
...
<img src="../../../../../../.gitbook/assets/Phan_quyen_truy_cap_ACLs (1).gif" alt="" data-size="original">
