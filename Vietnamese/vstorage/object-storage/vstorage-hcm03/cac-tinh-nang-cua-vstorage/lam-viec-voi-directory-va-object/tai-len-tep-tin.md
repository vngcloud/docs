...
Tất cả dữ liệu do bạn tải lên đều thuộc sở hữu của bạn, GreenNode sẽ không thể can thiệp hay khôi phục dữ liệu khi bị xóa hay ghi đè bởi lỗi người dùng. Để tránh các các sự cố về ghi đè hay xóa nhầm chúng tôi khuyến khích bạn nên sao lưu phiên bản container (tính năng versioning) để bảo vệ dữ liệu. Để xem chi tiết tính năng versioning, hãy xem [Sử dụng tính năng container versioning](../lam-viec-voi-container/su-dung-tinh-nang-container-versioning.md).

<img src="../../../../../.gitbook/assets/Tai_len_tep_tin.gif" alt="" data-size="original">
