...
2\. Chọn biểu tượng ![](https://docs.vngcloud.vn/download/thumbnails/49648432/image2023-2-1_14-25-3.png?version=1\&modificationDate=1675236304000\&api=v2) tại **project** bạn muốn xem chi tiết.
...
* **Thành viên**: Cung cấp thông tin member được thêm quyền truy cập vào project từ vStorage Portal cũ. Chúng tôi chỉ hỗ trợ tính năng **Thêm thành viên** trên vStorage Portal cũ. Bây giờ bạn có thể phân quyền truy cập cho người dùng từ hệ thống phân quyền truy cập vIAM mà GreenNode cung cấp. Tham khảo thêm tại: [Phân quyền truy cập](../../quan-ly-truy-cap/).
...
* **S3 key**: Cung cấp thông tin các cặp S3 key được khởi tạo cho project từ vStorage Portal cũ. Chúng tôi chỉ hỗ trợ tính năng **Khởi tạo S3 key** trên vStorage Portal cũ. Bây giờ bạn có thể khởi tạo các cặp S3 key từ hệ thống phân quyền truy cập vIAM mà GreenNode cung cấp. Tham khảo thêm tại: [Phân quyền truy cập](../../quan-ly-truy-cap/).
...
<figure><img src="../../../../../../.gitbook/assets/Xem_thong_tin_project (1).gif" alt=""><figcaption></figcaption></figure>
