...
1. Truy cập vào trang chủ vConsole tại: [https://dashboard.console.greennode.ai/](https://dashboard.console.greennode.ai/)
...
1. Truy cập vào trang Thống kê sử dụng / Usage report tại: [https://dashboard.console.greennode.ai/usage-report](https://dashboard.console.greennode.ai/usage-report)
...
1. Truy cập vào trang Lịch sử hóa đơn / Billing history tại: [https://dashboard.console.greennode.ai/billing-report](https://dashboard.console.greennode.ai/billing-report)
...
1. Truy cập vào trang Lịch sử thanh toán / Payment history tại: [https://dashboard.console.greennode.ai/payment-history](https://dashboard.console.greennode.ai/payment-history)
...
1. Truy cập vào trang Lịch sử tín dụng / Credit history tại: [https://dashboard.console.greennode.ai/credit-history](https://dashboard.console.greennode.ai/credit-history)
